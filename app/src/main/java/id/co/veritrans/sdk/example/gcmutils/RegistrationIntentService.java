...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            Logger.i("at "+TAG+" onHandleIntent");
            ...
            String oldToken = sharedPreferences.getString(Constants.GCM_REGISTERED_TOKEN,"");
            sharedPreferences.edit().putString(Constants.GCM_REGISTERED_TOKEN,token).apply();
            // [END get_token]
            ...
            if(!token.equalsIgnoreCase(oldToken)) {
                ...
                Logger.i("Token already registered");
            }
     ...
     *
     * @param token
     * @param oldToken The new token.
     */
    private void sendRegistrationToServer(String token, String oldToken) {
        // Add custom implementation, as needed.
        RegisterDeviceRequest registerDeviceRequest = new RegisterDeviceRequest(token,oldToken);
        Utils.registerTokenMerchant(getApplicationContext(), registerDeviceRequest, new RegisterTokenCallback() {
            ...
            @Override
            public void onFailure(String errorMessage, RegisterDeviceResponse registerDeviceResponse) {
                Logger.i("Failed to registered token to merchant");
                // add code to retry below
            }
        });
    }
